  ...
  return (
    <>
      ...
      <div ref={exportRef} style={{
        ...
        width: 600, padding: 48, borderRadius: 20,
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 28 }}>
          {highCount > 0 && <span style={{ fontSize: 10, color: '#DC2626', backgroundColor: '#FEF2F2', border: '1px solid #FECACA', padding: '5px 12px', borderRadius: 8, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>{highCount} High Risk</span>}
          {mediumCount > 0 && <span style={{ fontSize: 10, color: '#D97706', backgroundColor: '#FFFBEB', border: '1px solid #FDE68A', padding: '5px 12px', borderRadius: 8, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>{mediumCount} Medium Risk</span>}
          {lowCount > 0 && <span style={{ fontSize: 10, color: '#059669', backgroundColor: '#ECFDF5', border: '1px solid #A7F3D0', padding: '5px 12px', borderRadius: 8, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>{lowCount} Low Risk</span>}
          {totalTraps === 0 && <span style={{ fontSize: 10, color: '#059669', backgroundColor: '#ECFDF5', border: '1px solid #A7F3D0', padding: '5px 12px', borderRadius: 8, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>No traps detected</span>}
        </div>

        <div style={{ borderTop: '1px solid #F3F4F6', paddingTop: 20 }}>
          <p style={{ fontSize: 10, color: '#9CA3AF', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 700 }}>app.worktugal.com/diagnostic · Free Portugal compliance check</p>
        </div>
      </div>
    </>
  );
