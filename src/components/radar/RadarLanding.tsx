  ...
  return (
    <>
      <Seo
        ...
        description="Free weekly headline: what changed in Portuguese regulations this week. Worktugal Pro €5/mo: what to do about it before the deadline."
        ogTitle="Portugal Radar - never miss a rule change"
        ogDescription="Free weekly updates on Portuguese law changes affecting your visa, tax, and residency. Worktugal Pro €5/mo for step-by-step actions."
      ...
      <section className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="bg-gradient-to-b from-[#0F3D2E] to-[#0A2B20] rounded-2xl p-10 text-center flex flex-col items-center gap-6 relative overflow-hidden border border-[#10B981]/10">
          ...
          />
          <span className="inline-flex items-center text-[10px] font-black uppercase tracking-[0.2em] text-[#10B981] bg-[#10B981]/15 px-3 py-1.5 rounded-full relative z-10">
            WORKTUGAL PRO
          </span>
          <motion.h2
            {...fadeUp}
            className="text-2xl md:text-3xl font-black text-white relative z-10 leading-tight"
          >
            €5/mo. Cancel anytime.
          </motion.h2>
          ...
          <a
            href="https://app.worktugal.com/login?redirect=subscribe"
            className="inline-flex items-center gap-2 bg-[#10B981] text-white px-8 py-4 rounded-xl text-base font-bold hover:bg-[#059669] hover:scale-[1.03] active:scale-[0.97] transition-all shadow-2xl shadow-black/20 relative z-10"
          >
            Subscribe to Worktugal Pro <ArrowRight className="w-4 h-4" />
          </a>
          <p className="text-xs text-white/30 relative z-10">
            Sign in with Google. No credit card until you subscribe.
          </p>
        </div>
      </section>
      )}
