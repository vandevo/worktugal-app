...
export type { DiagnosticQuestion, DiagnosticAnswers, DiagnosticContactInfo, DiagnosticResult, DiagnosticSegment, DiagnosticSubmission, TrapRule, TriggeredTrap, TrapSeverity } from './types';
