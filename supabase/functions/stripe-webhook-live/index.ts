  ...
  try {
    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        html: `<div style="max-width:600px;margin:0 auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1e293b"><p>Hi ${name},</p><p>Your Worktugal Pro subscription is active. You now have full access to:</p><ul style="padding-left:20px"><li style="margin-bottom:8px"><strong>Weekly brief</strong>: what changed, what it means, and exactly what to do</li><li style="margin-bottom:8px"><strong>Step-by-step actions</strong> before each compliance deadline</li><li style="margin-bottom:8px"><strong>Compliance calendar</strong>: upcoming filing dates for Portugal</li><li style="margin-bottom:8px"><strong>Full archive</strong> of past briefs</li></ul><p style="margin-top:24px"><a href="https://app.worktugal.com/dashboard" style="background:#0F3D2E;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;font-weight:600">Go to Dashboard</a></p><p style="margin-top:32px;color:#64748b;font-size:14px">Reply to this email if you need help.<br>Van from Worktugal</p></div>`,
      }),
    });
